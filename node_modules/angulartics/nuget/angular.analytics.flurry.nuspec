...
<package xmlns="http://schemas.microsoft.com/packaging/2010/07/nuspec.xsd">
    <metadata>
        ...
        <description>Flurry module for Angulartics.
See Angular.Analytics.Core for more details

[NuGet packaging by ADAPTByDesign]
</description>
        <summary>Flurry for AngularJS applications</summary>
        <releaseNotes />
        <copyright />
    ...
    <files>
        ...
        <file src="..\dist\angulartics-flurry.min.js" target="content\Scripts\angulartics-flurry.min.js" />
    </files>
</package>